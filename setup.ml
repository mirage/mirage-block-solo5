...
(* OASIS_START *)
(* DO NOT EDIT (digest: 6975223d6abc9175401dc71b7d73a6ec) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis = "Solo5 block frontend and backend driver implementation";
          description = None;
          categories = [];
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "mirage-block-solo5";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\029Ky\005\015\208K\235\240\026=\159\138\167\237&";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
