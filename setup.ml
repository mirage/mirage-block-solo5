...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7c54a4756907640492171f73103b3381) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis = "Solo5 block driver implementation";
          description = None;
          categories = [];
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\135z\132-\193j\162\157.\210\189n\176\0018p";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
